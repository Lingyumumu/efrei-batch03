...
if(isset($_POST['btnRegister'])){
    ...
    $query = "INSERT INTO tblstudents(first_name,last_name,email,password,country) VALUES('$fname','$lname','$email','$password','$country')";
...
<body>
    ...
    <form action='login.php' method='post'>
        ...
        Email Address: <input type='email' name='txtEmail' required><br>
